package com.starshop.security.filter;
...
public class JwtFilter extends AuthenticatingFilter {
    ...
    protected AuthenticationToken createToken(ServletRequest servletRequest, ServletResponse servletResponse) throws Exception {
        ...
        if (tokenWhitelistCache != null) {
            ...
            if (cachedClaims != null) {
                ...
                return new JwtToken(cachedClaims.get(JwtClaimsConstant.SYS_USER_ID).toString(), token, cachedClaims);
            }
        }
        ...
        try {
            ...
            String userId = claims.get(JwtClaimsConstant.SYS_USER_ID).toString();
    ...
    protected boolean onAccessDenied(ServletRequest servletRequest, ServletResponse servletResponse) {
        ...
        try {
            ...
            if (sysUser != null) {
                BaseContext.setUserInfo(sysUser.getUserInfo());
            }
